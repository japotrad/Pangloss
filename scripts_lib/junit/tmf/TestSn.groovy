...
class TestSn {
	...
	public final void testAddIu() {
		...
		assertEquals "tmf.Iu", sn.informationUnits[0].class.name
		...
		assertEquals "tmf.Iu", sn.informationUnits[1].class.name
	...
	public final void testAddSn() {
		...
		assertEquals "tmf.Sn", sn.children["child"].class.name
		assertEquals child, sn.children["child"]
		
		Sn child2 = new Sn("child2")
		sn.add(child2)
		assertEquals 2, sn.children.size()
		assertEquals "tmf.Sn", sn.children["child2"].class.name
